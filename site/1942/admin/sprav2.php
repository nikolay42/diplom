...
Обработанные заказы  </td> <!--<td> <form   method='post' name='excel' action='excel.php'>
...
if ($kolvo>0)
{
echo "<table border='0' align='center' width='700'><tr><td class='table1'> Всего обработанных  заказов &nbsp;<b>$kolvo</b></td></tr> </table>\n";

$res=mysql_query("SELECT `forname`, `email`, `telrab`, `date`, `status`, `nomzak`, `vsnam`, `sumkol`, `sumprise`, `sumusl`, `summazakaza`, idu FROM `userreg`  where status=2 ");
$a=1;
echo "<center> <table>
<tr>
...
<td> <form   method='post' name='vid' action='udal.php'>
<INPUT TYPE='hidden' NAME='vid' VALUE='$res_id[11]'>
<input type='image' src='../image/vid.png' TITLE='Пометить обработанным' WIDTH='30' HEIGHT='30' >
</form></td> 
</tr> \n";
$a=$a+1;
}   
...
echo "<p class='pp'> Обработанных  заказов не обнаружено </p> ";
}
?>	
