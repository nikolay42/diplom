...
FROM user
WHERE  idu='{$_SESSION['var']}' ";
$res_id=mysql_query($query1);
if(mysql_query($query1))
while($sod_mas=mysql_fetch_row($res_id))
{
echo "<div class='loginsite'> <strong>Вы вошли как:</strong> <em>$sod_mas[0]</em></div>";
}
                   
?>    </td> <td align="right" width="600"> <img src="../image/advancedsettings.png" width="80" height="80" alt="меню администратора">
<h4> Панель администратора </h4> </td> </tr>	
				<tr> <td> </td> <td> </td> </tr>
				</table>
...
<html>
    <div id="menu">
		<ul class="menu">
			<li>
				<a href='glav.php' class='c1'>Главная</a>
				<ul class="submenu">
				<li><a href='glav.php'>Главная новость </a></li>
					<li><a href='contred.php'>Контакты</a></li>
					<li><a href='menured.php'>Меню </a></li>
				</ul>
			</li>
			<li>
				<a href='sprav1.php' class='c1'>Заказы</a>
				<ul class="submenu">
					<li><a href='sprav1.php'>Поступившие</a></li>
...
<li><a href='otziv.php'>Отзывы </a></li>
			...
			<li>
				<a href='modeli.php' class='c1'> Справочники </a>
					<ul class="submenu">
<li><a href='redaktuser.php'>Пользователи </a></li>
...
<li><a href='podkat.php'>Добавление подкатегорий </a></li>
						...
						<li><a href='addnews.php'>Добавление статьи</a></li>
					<li><a href='redaktnews.php'>Редактирование статьи</a></li>
<li><a href='vendor.php'>Производители </a></li>
<li><a href='addusl.php'>Добавление услуг </a></li>
