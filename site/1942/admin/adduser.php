...
<table width="100%" border="1" cellspacing="5" cellpadding="5">
  <tr>
    <td valign="top" ><h3> Добавление сотрудников </h3></td> <td valign="top"> 
 </td>
  </tr>
...
<tr>
	...
	<td class=" "><input type="text" size="40" name="login" class="required"  title="<p class=' '>Поле обязательно к заполнению</p>"  value="" ></td>
	<td class="tr">Не менее 6 символов, латиница и цифры</td>
</tr>
<tr>
	<td class="but1">Пароль</td>
	<td class=" "><input type="text" size="40" name="password" class="required"  title="<p class=' '>Поле обязательно к заполнению</p>" value="" ></td>
	<td class="tr">Не менее 6 символов, латиница и цифры</td>
</tr>
<tr>
	<td colspan="3"  > <center> <br><input type="submit" value="Зарегистрировать" name="reg"><br>
      </form><br></td>
</tr>
<tr>
...
{
echo "<p class=''>Пользователь зарегистрирован</p>";
}
else
{
