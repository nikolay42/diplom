...
$tn .= '<p class="but1"> Услуга учтена, изображение успешно загружено.<p/>';
echo $tn;

$queryforum="insert into usl (`linkusl`, `nameusl`, `opisusl`, `stoimusl`, `proz`) values
 ('".$_FILES['fupload']['name']."','".$_POST['nameusl']."', '".$_POST['opisusl']."', '".$_POST['stoimusl']."', '".$_POST['proz']."')"; /*вставляем данные о рисунке в БД*/
