...
<table width="800" border="0" cellspacing="0" cellpadding="0">
 <tr>
    ...
    <tr>
    <td width="10">&nbsp;</td>
    <td width="320" class="date1">Название карты</td>
    <td width="10">&nbsp;</td>
...
$query1="insert into karta (`namek`,`imagekart`) 
...
<?php 
require "../dbconnect.php";
$sod1=mysql_query("SELECT count( idk )
FROM karta
WHERE udalk=0");
...
if ($kolvo>0)
{
echo "<table border='0' align='center' width='700'><tr><td class='table1'> Всего учтено карт &nbsp;<b>$kolvo</b></td></tr> </table>\n";
}
?>
<?php
require "../dbconnect.php";
$res=mysql_query("SELECT `namek`, `imagekart`, idk FROM karta  where udalk=0 ");
$a=1;
echo "<center> <table>";
...
<td width='300' class='kvit'> $res_id[0] </td>
<td width='50' class='pp'> <img src='../images/$res_id[1]' WIDTH='150' HEIGHT='100' /> </td>
<td> <form   method='post' name='udalk' action='udal.php'>
<INPUT TYPE='hidden' NAME='udalk' VALUE='$res_id[2]'>
