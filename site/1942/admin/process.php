...
$queryforum="insert into image (`linki`, namei, tip, `nametov`, `art`, `prise`, ves) values 
('".$_FILES['fupload']['name']."','".$_POST['opis']."', '".$_POST['tip']."', '".$_POST['nametov']."', '".$_POST['art']."','".$_POST['prise']."', '".$_POST['idven']."')"; /*вставляем данные о рисунке в БД*/
