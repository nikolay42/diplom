...
Заказы в архиве  </td> <!--<td> <form   method='post' name='excel' action='excel.php'>
...
if ($kolvo>0)
{
echo "<table border='0' align='center' width='700'><tr><td class='table1'> Всего заказов в архиве&nbsp;<b>$kolvo</b></td></tr> </table>\n";

$res=mysql_query("SELECT `forname`, `email`, `telrab`, `date`, `status`, `nomzak`, `vsnam`, `sumkol`, `sumprise`, `sumusl`, `summazakaza`, idu FROM `userreg`  where status=3 ");
$a=1;
echo "<center> <table>
<tr>
...
echo "<p class='pp'> Заказов в архиве не обнаружено </p> ";
}
?>	
