...
if(isset($_POST['udalspisusl'])) 
{
$minusot=$_POST['udalspisusl'];
$res077="update usl set udalusl=1 where idusl='$minusot'";
if(mysql_query($res077))
{
Header ("Location: spisusl.php");
} 
}
?>
