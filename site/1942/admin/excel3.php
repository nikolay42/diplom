...
FROM `userreg`, model  where idmod=idkart and  status=3");
...
if ($kolvo>0)
{
echo "<table border='0' align='center' width='700'><tr><td class='table1'> Всего  заявок в архиве &nbsp;<b>$kolvo</b></td></tr> </table>\n";
}
?>
<?php
require "../dbconnect.php";
$res=mysql_query("SELECT idu, namemod, forname, name, otch, teluser, adressreg, adressfakt, adressfakttel FROM `userreg`, model  where idmod=idkart and  status=3 ");
$a=1;
echo "<center> <table>";
