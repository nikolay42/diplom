...
Заказы, удаленные пользователями  </td> <!--<td> <form   method='post' name='excel' action='excel.php'>
...
if ($kolvo>0)
{
echo "<table border='0' align='center' width='700'><tr><td class='table1'> Всего удаленных заказов &nbsp;<b>$kolvo</b></td></tr> </table>\n";

$res=mysql_query("SELECT `forname`, `email`, `telrab`, `date`, `status`, `nomzak`, `vsnam`, `sumkol`, `sumprise`, `sumusl`, `summazakaza`, idu FROM `userreg`  where status=1 ");
$a=1;
echo "<center> <table>
<tr>
...
echo "<p class='pp'> Удаленных пользователями заказов не обнаружено </p> ";
}
?>	
    </div> 
            </div> 
