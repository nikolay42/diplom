...
$queryforum="insert into stol (`linkim`, opism, namemod, prise) values ('".$_FILES['fupload']['name']."','".$_POST['opismodel']."', '".$_POST['namemodel']."', '".$_POST['prise']."')"; /*вставляем данные о рисунке в БД*/
