...
$queryforum="insert into model (`linkim`, opism, namemod, kkk, fat) values ('".$_FILES['fupload']['name']."','".$_POST['opismodel']."', '".$_POST['namemodel']."', 1, '".$_POST['kat']."')"; /*вставляем данные о рисунке в БД*/
