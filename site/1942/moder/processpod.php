...
$queryforum="insert into model (`linkim`, opism, namemod, prise, kkk, fat) values ('".$_FILES['fupload']['name']."','".$_POST['opismodel']."', '".$_POST['namemodel']."', '".$_POST['prise']."', 1, '".$_POST['kat']."')"; /*вставляем данные о рисунке в БД*/
