...
Поле обязательно к заполнению"> </td> <td colspan="2"> <input type="file" name="fupload" size="50" /> </td> </tr>
<tr> 
...
<td><input type="text" size="30"  name="prise" class="required" title="<br> Поле обязательно к заполнению"> </td>
<td> <input type="text" size="30"  name="art" class="required" title="<br> Поле обязательно к заполнению"></td>

</tr>
</table>
<p class="kvit"> Описание  </p>
<div class="" >  <textarea ROWS=2 COLS=30 name="opis" > </textarea> 
 </div> 
