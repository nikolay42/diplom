...
`art`='".$_POST['art']."',`prise`='".$_POST['prise']."', `met`='".$_POST['met']."', `ves`='".$_POST['idven']."' where idi=$tovcut"; /*вставляем данные о рисунке в БД*/
if(mysql_query($queryforum)) /* если запрос успешно произведен */
{
echo "<p class='but1'> Сведения о товаре  успешно изменены<p/>";
}
else
{
