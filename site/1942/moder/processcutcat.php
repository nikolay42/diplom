...
$updatecut="update model set linkim='$link', opism='$opismodel', namemod='$namemodel', fat=$kat where idmod=$nomnews1"; /*вставляем данные о рисунке в БД*/
if(mysql_query($updatecut)) /* если запрос успешно произведен */
{
echo "<p class='but1'> Сведения о подкатегории успешно изменены<p/>";
}
else {
echo "не получилось обновить данные";
}
}
