...
Поступившие заказы  </td> <!--<td> <form   method='post' name='excel' action='excel.php'>
...
$res=mysql_query("SELECT `forname`, `email`, `telrab`, `date`, `status`, `nomzak`, `vsnam`, `sumkol`, `sumprise`, `sumusl`, `summazakaza`, idu FROM `userreg`  where status=0 ");
$a=1;
echo "<center> <table>
<tr>
...
<input type='image' src='../image/plus.png' TITLE='В производство' WIDTH='30' HEIGHT='30' >
</form> </td> 
</tr> \n";
$a=$a+1;
}   
...
echo "<p class='pp'> Новых заказов не обнаружено </p> ";
}
?>	
