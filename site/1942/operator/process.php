...
$tn .= '<p class="but1"> Товар учтен, изображение успешно загружено.<p/>';
echo $tn;

$queryforum="insert into image (`linki`, namei, tip, `nametov`, `art`, `prise`, `met`, `ves`) values 
('".$_FILES['fupload']['name']."','".$_POST['opis']."', '".$_POST['tip']."', '".$_POST['nametov']."', '".$_POST['art']."','".$_POST['prise']."', '".$_POST['met']."','".$_POST['idven']."')"; /*вставляем данные о рисунке в БД*/
