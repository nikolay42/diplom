...
?>    </td> <td align="right" width="600"> <img src="../image/operator.png" width="80" height="80" alt="меню администратора">
<h4> Меню оператора  </h4> </td> </tr>	
				<tr> <td> </td> <td> </td> </tr>
				</table>
...
<li><a href='sprav5.php'>Удаленные  пользователями</a></li> 
			...
			<li>
				<a href='modeli.php' class='c1'> Товары </a>
					<ul class="submenu">
